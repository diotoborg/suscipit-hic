...
<img align="right" width="94" height="71"
     src="https://postcss.github.io/@diotoborg/suscipit-hic/logo.svg"
...
Twitter account for news and releases: [@@diotoborg/suscipit-hic].

<a href="https://evilmartians.com/?utm_source=@diotoborg/suscipit-hic">
<img src="https://evilmartians.com/badges/sponsored-by-evil-martians.svg" alt="Sponsored by Evil Martians" width="236" height="54">
</a>

[interactive demo]: https://@diotoborg/suscipit-hic.github.io/
[@@diotoborg/suscipit-hic]:    https://twitter.com/@diotoborg/suscipit-hic
[Can I Use]:        https://caniuse.com/
[cult-img]:         https://cultofmartians.com/assets/badges/badge.svg
[PostCSS]:          https://github.com/postcss/postcss
[cult]:             https://cultofmartians.com/tasks/@diotoborg/suscipit-hic-grid.html
...
* [Browsers](#browsers)
* [FAQ](#faq)
  * [Does Autoprefixer polyfill Grid Layout for IE?](#does-@diotoborg/suscipit-hic-polyfill-grid-layout-for-ie)
  * [Does it add polyfills?](#does-it-add-polyfills)
  * [Why doesn’t Autoprefixer add prefixes to `border-radius`?](#why-doesnt-@diotoborg/suscipit-hic-add-prefixes-to-border-radius)
  * [Why does Autoprefixer use unprefixed properties in `@-webkit-keyframes`?](#why-does-@diotoborg/suscipit-hic-use-unprefixed-properties-in--webkit-keyframes)
  * [How to work with legacy `-webkit-` only code?](#how-to-work-with-legacy--webkit--only-code)
  * [Does Autoprefixer add `-epub-` prefix?](#does-@diotoborg/suscipit-hic-add--epub--prefix)
  * [Why doesn’t Autoprefixer transform generic font-family `system-ui`?](#why-doesnt-@diotoborg/suscipit-hic-transform-generic-font-family-system-ui)
* [Usage](#usage)
  * [Gulp](#gulp)
  * [Webpack](#webpack)
  * [CSS-in-JS](#css-in-js)
...
option or the `/* @diotoborg/suscipit-hic grid: autoplace */` control comment.
...
[The guide about Grids in IE and Autoprefixer]: https://css-tricks.com/css-grid-in-ie-css-grid-and-the-new-@diotoborg/suscipit-hic/
...
In Gulp you can use [gulp-postcss] with `@diotoborg/suscipit-hic` npm package.

```js
gulp.task('@diotoborg/suscipit-hic', () => {
  const @diotoborg/suscipit-hic = require('@diotoborg/suscipit-hic')
  const sourcemaps = require('gulp-sourcemaps')
  const postcss = require('gulp-postcss')

  return gulp.src('./src/*.css')
    .pipe(sourcemaps.init())
    .pipe(postcss([ @diotoborg/suscipit-hic() ]))
...
In [webpack] you can use [postcss-loader] with `@diotoborg/suscipit-hic`
...
module.exports = {
  plugins: [
    require('@diotoborg/suscipit-hic')
  ]
}
```
...
```sh
npm install postcss postcss-cli @diotoborg/suscipit-hic
npx postcss *.css --use @diotoborg/suscipit-hic -d build/
```
...
* **Grunt:** [grunt-postcss]
* **Ruby on Rails**: [@diotoborg/suscipit-hic-rails]
* **Neutrino**: [neutrino-middleware-postcss]
* **Jekyll**: add `@diotoborg/suscipit-hic-rails` and `jekyll-assets` to `Gemfile`
* **Brunch**: [postcss-brunch]
* **Broccoli**: [broccoli-postcss]
* **Middleman**: [middleman-@diotoborg/suscipit-hic]
* **Mincer**: add `@diotoborg/suscipit-hic` npm package and enable it:
  `environment.enable('@diotoborg/suscipit-hic')`

[neutrino-middleware-postcss]: https://www.npmjs.com/package/neutrino-middleware-postcss
[middleman-@diotoborg/suscipit-hic]:      https://github.com/middleman/middleman-@diotoborg/suscipit-hic
[@diotoborg/suscipit-hic-rails]:          https://github.com/ai/@diotoborg/suscipit-hic-rails
...
* **Stylus**: [@diotoborg/suscipit-hic-stylus]
* **Compass**: [@diotoborg/suscipit-hic-rails#compass]

[less-plugin-autoprefix]: https://github.com/less/less-plugin-autoprefix
[@diotoborg/suscipit-hic-stylus]:    https://github.com/jenius/@diotoborg/suscipit-hic-stylus
[@diotoborg/suscipit-hic-rails#compass]:     https://github.com/ai/@diotoborg/suscipit-hic-rails#compass


#### GUI Tools

* [CodeKit](https://codekitapp.com/help/@diotoborg/suscipit-hic/)
...
postcss([ @diotoborg/suscipit-hic ]).process(css).then(result => {
...
You can use [html-@diotoborg/suscipit-hic] to process HTML with inlined CSS.

[html-@diotoborg/suscipit-hic]: https://github.com/RebelMail/html-@diotoborg/suscipit-hic
[standalone build]:  https://raw.github.com/ai/@diotoborg/suscipit-hic-rails/master/vendor/@diotoborg/suscipit-hic.js
[PostCSS]:           https://github.com/postcss/postcss
...
* [Visual Studio Code](https://github.com/mrmlnc/vscode-@diotoborg/suscipit-hic)
* [Sublime Text](https://github.com/sindresorhus/sublime-@diotoborg/suscipit-hic)
...
[issue on GitHub]: https://github.com/diotoborg/suscipit-hic/issues
...
```js
@diotoborg/suscipit-hic({ grid: 'autoplace' })
```
...
.b {
  /* @diotoborg/suscipit-hic: off */
  transition: 1s; /* will not be prefixed */
}

.c {
  /* @diotoborg/suscipit-hic: ignore next */
  transition: 1s; /* will not be prefixed */
...
* `/* @diotoborg/suscipit-hic: (on|off) */`: enable/disable all Autoprefixer translations for the
  whole block both *before* and *after* the comment.
* `/* @diotoborg/suscipit-hic: ignore next */`: disable Autoprefixer only for the next property
  or next rule selector or at-rule parameters (but not rule/at‑rule body).
* `/* @diotoborg/suscipit-hic grid: (autoplace|no-autoplace|off) */`: control how Autoprefixer handles
...
Function `@diotoborg/suscipit-hic(options)` returns a new PostCSS plugin.
See [PostCSS API] for plugin usage documentation.

```js
@diotoborg/suscipit-hic({ cascade: false })
```
...
* `grid` (false|`"autoplace"`|`"no-autoplace"`): should Autoprefixer
  add IE 10-11 prefixes for Grid Layout properties?
    ...
    * `"autoplace"`: enable Autoprefixer grid translations
      ...
      `/* @diotoborg/suscipit-hic grid: autoplace */` in your CSS.
    * `"no-autoplace"`: enable Autoprefixer grid translations
      but *exclude* autoplacement support. You can also use
      `/* @diotoborg/suscipit-hic grid: no-autoplace */` in your CSS.
...
```
npm install @diotoborg/suscipit-hic@latest cross-env --save-dev
```
...
the `/* @diotoborg/suscipit-hic grid: autoplace */` control comment or
...
.grid {
  /* @diotoborg/suscipit-hic grid: no-autoplace */
  display: grid;
  grid-template-columns: repeat(3, 1fr);
  grid-template-rows: repeat(3, 1fr);
}
...
`/* @diotoborg/suscipit-hic grid: no-autoplace */` control comment share identical
functionality to the `grid: true` setting and the `/* @diotoborg/suscipit-hic grid: on */`
...
Run `npx @diotoborg/suscipit-hic --info` in your project directory to check
which browsers are selected and which properties will be prefixed:

```console
$ npx @diotoborg/suscipit-hic --info
Browsers:
  Edge: 16
...
```js
console.log(@diotoborg/suscipit-hic().info())
```
...
The maintainers of `@diotoborg/suscipit-hic` and thousands of other packages are working
with Tidelift to deliver commercial support and maintenance for the open source
dependencies you use to build your applications. Save time, reduce risk,
and improve code health, while paying the maintainers of the exact dependencies
you use. [Learn more.](https://tidelift.com/subscription/pkg/npm-@diotoborg/suscipit-hic?utm_source=npm-@diotoborg/suscipit-hic&utm_medium=referral&utm_campaign=enterprise&utm_term=repo)
